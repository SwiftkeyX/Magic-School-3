...
public abstract class SkillEffect
{
    ...
    // IReadOnlyList rather than List so a caller's List<Hero> converts implicitly - the
    // interface is covariant, so every existing call site keeps passing what it already had.
