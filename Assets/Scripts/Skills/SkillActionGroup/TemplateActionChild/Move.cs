...
namespace MagicSchool.Skills
{
    ...
    internal class Move : TemplateAction
    {
        ...
        protected override void Play()
        {
            ...
            // Claim the landing hex at take-off rather than on arrival, so nobody walks into it
            // while the caster is in the air. Same reason HeroWalk reserves the hex it commits to
            // instead of the one it reaches.
